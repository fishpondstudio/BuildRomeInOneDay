...
export const Config = {
   ...
   RomeHistory: Object.freeze(new RomeHistoryDefinitions()),
   RomeHistoryStage: Object.freeze(new RomeHistoryStageDefinitions()),
   BuildingTier,
   BuildingTech,
   ResourceTier,
   ResourceTech,
...
const definitions = Config.RomeHistory;

// Set basic building/resource
